...
# device.disconnect()
import mtpy_master.mtpy as mtpy
import os
try:
...
# p = dev.get_descendant_by_path("/Android/data/net.osmand.plus/files/")
# "/Android/data/net.osmand.plus/files/avnotes/"
p = dev.get_descendant_by_path("/Android/data/net.osmand.plus/files/tracks/rec/")
p.retrieve_to_folder("/tmp/files/rec")